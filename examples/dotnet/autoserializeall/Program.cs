...
namespace Apache.Geode.Examples.Serializer
{
  public class Program
  {
    public static void Main(string[] args)
    {
      ...
      // Put types directly in this region
      var directRegion = regionFactory.Create<object, object>("dotnettypes");

      // Put types directly in this region
      var classRegion = regionFactory.Create<int, Order>("usertypes");
